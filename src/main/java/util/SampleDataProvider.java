...
@Component
@Profile("with-data")
class SampleDataProvider implements ApplicationListener<ContextRefreshedEvent>,
		ApplicationContextAware {
	private static boolean called = false;

	private static final Logger LOG = LoggerFactory
			.getLogger(SampleDataProvider.class);
	...
	/**
	 * Creates a new {@link SampleDataProvider} to populate the given
	 * {@link DataSource}.
	 * 
	 * @param dataSource
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		if (!called) {
			...
			populator.setScripts(new Resource[] { new ClassPathResource(
					SQL_FILE) });
